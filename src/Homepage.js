                ...
                <div className="steps-list">
                    ...
                    <div className="step-text">
                        ...
                        <div>
                            ...
                            <p>You'll have to wait a bit until one of our skilled bartenders will be able to prepare your order. We'll let you know when it's ready.</p>
                        </div>
                    </div>
                    ...
                    <div className="step-text">
                        ...
                        <div>
                            ...
                            <p>You are one step closer to your drink, but you have to work for it a bit. You can get your order at the counter.</p>
                        </div>
                    </div>
