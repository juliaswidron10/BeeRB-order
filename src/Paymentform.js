...
const Paymentform = () => {
  ...
  return (
    <div className="modal payment-modal hidden">
      ...
      >
        ...
        <Form.Item label="Expiration date (MM/YY)" style={{ marginBottom: 0 }}>
          <Form.Item name="expirationdate" rules={[{ required: true, message: "Enter a valid card expiration date" }]}>
        ...
        <Form.Item label=" " colon={false}>
          <Button className="btn-orange" type="primary" htmlType="submit">
            Complete payment
          </Button>
        </Form.Item>
      </Form>
